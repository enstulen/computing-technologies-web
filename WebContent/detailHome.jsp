					...
					<div class="row">
						...
						<div class="col-md-6 animate-box">
							<span class="description">
								<p>Estudio en Sol es un acogedor alojamiento en pleno centro
									de Madrid, donde en cada esquina se encuentra la diversiÃ³n
									debido a los innumerables bares, restaurantes, tiendas y
									mercados de la zona. El apartamento cuenta con cocina
									americana, wifi gratis en todas las zonas, televisiÃ³n, horno y
									microondas, lavadora, secador de pelo, cafetera y tostadora. Se
									facilitan sÃ¡banas y toallas a la llegada.</p>
							</span>
							<table class="table">
								<tbody>
									<tr>
